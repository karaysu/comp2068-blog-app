...
const Index = function ({user}) {
	...
	const deleteBlog = async (blog) => {
		try {
			...
			if (resp.status === 200)
				toast('The blog was deleted successfully', { type: toast.TYPE.SUCCESS });
						...
						<div key={i} className="card my-3">
							...
							{user ? (
								<div className="card-footer">
									...
									<button type="button" className="delete-button" onClick={() => {if (window.confirm('Are you sure you wish to delete this item?')) deleteBlog(blog)}}>
